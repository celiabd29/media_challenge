      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          ...
          <input
            ...
            className={`w-full mt-1 p-3 border rounded-lg placeholder-gray-400 ${darkMode ? 'bg-[#1E293B] text-white border-gray-600' : 'bg-white text-gray-700 border-gray-300'}`}
            required
          />
        </div>
        ...
        {/* Fichier audio */}
        <div>
          <label className="text-sm block">Fichier audio</label>
          <div className={`border border-dashed rounded-lg mt-2 p-4 text-center cursor-pointer ${darkMode ? 'border-gray-500' : 'border-gray-400'}`}>
            <input
              type="file"
              accept="audio/*"
