...
// Icônes définies comme composants React
...
const navItems = [
  ...
  { name: "Compte",    icon: AccountIcon, href: "/compte"  },
]
...
export default function BottomNavbar() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-50 bg-white rounded-tl-2xl rounded-tr-2xl border-t flex justify-around items-center py-3 shadow-2xl">
      {navItems.map(({ name, icon: Icon, href }) => {
        ...
        return (
          ...
          >
            ...
            {/* titre à droite uniquement si actif */}
            {isActive && (
